...
async function loadCards(teamId) {
  ...
  cards.forEach((c) => {
    ...
    editBtn.addEventListener("click", () =>
      window.editCard(c.id, c.title, c.description, c.etag || "*"),
    );
...
// Función global para preparar la edición
window.editCard = (id, title, description, etag) => {
  document.getElementById("cardId").value = id;
  document.getElementById("cardName").value = title;
  document.getElementById("cardDesc").value = description;
  document.getElementById("cardEtag").value = etag;
};
